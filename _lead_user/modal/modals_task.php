<div class="modal fade" id="leads_project_modal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                    ...
                    <div class="row d-none">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="lead_project_id" name="lead_project_id" placeholder="ID">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-sm-6">
                         ...
                         <div class="col-12 col-sm-6 d-none">
                            <div class="form-group">
                                <label>Lead</label>
                                <input type="text" class="form-control" id="lead_id" name="lead_id" placeholder="" value="<?php echo $id;?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="2" id="lead_project_description" name="lead_project_description" maxlength="150"></textarea>
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="save_lead_project" name="save_lead_project">Save</button>
            </div>
        </div>
    </div>
</div>
<!-- task modal -->
<div class="modal fade" id="leads_task_modal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-body">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                <label>Description</label>
                                <textarea class="form-control" rows="2" id="task_description" name="task_description" maxlength="150"></textarea>
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="save_lead_tasks" name="save_lead_tasks">Save</button>
            </div>
        </div>
    </div>
</div>