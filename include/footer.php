...
<script src="../template_files/encryption/aes.js"></script>
<script>
...
<script src="../include/google_maphelper.js" type="text/javascript"></script>
...
<script src="../template_files/bootstrap-switch/js/bootstrap-switch.min.js"></script>
...
<script>
  $(function () {
    ...
    //Date picker
    $('#landlord_bought_on').datetimepicker({
        format: 'L'
    });
    
    $('#landlord_sold_on').datetimepicker({
        format: 'L'
    });
    $('#payments_date').datetimepicker({
        format: 'L'
    });
