...
if ($isNew === 'true') {
    ...
    `city`, `state`, `zipcode`, `address1`, `address2`, `login_user_id`, `managed_by`, `created_by`, `created_on`, `is_active`)
    VALUES ('$uid','$leads_firstname','$leads_midname','$leads_lastname','$leads_title','$leads_phone','$leads_mobile','$leads_email',
    '$leads_city','$leads_state','$leads_zipcode','$leads_address1','$leads_address2','$current_user','$managed_by','$current_user',now(),'1')";
} else if ($isNew === 'false') {
