...
{
    var isNew = false;
    var leads_logged = decryption_parameter($("#leads_logged").val());
                ...
                success: function (result)
                {
                    if (result.trim() != '')
                    {
                        if (isNew == true)
                        {
                            ...
                            toastr_success_parameter('Leads Added Successfully..!', '/leads/index_payments', result);
                        } else
                        {
                            modal_hide('leads_modal_box');
            ...
            ({
                ...
                success: function (result)
                {
                    if (result == 1)
                    {
                        ...
                        toastr_success('Leads Deleted Successfully..!', '');
                    } else
                    {
                        toastr_error();
                    }
